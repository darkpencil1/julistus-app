...
var ControlledBase = class extends import_react.default.Component {
  ...
  componentWillUnmount() {
    ...
    (_l = (_k = this.refModalImg.current) == null ? void 0 : _k.removeEventListener) == null ? void 0 : _l.call(_k, "transitionend", this.handleZoomEnd);
    (_n = (_m = this.refModalImg.current) == null ? void 0 : _m.removeEventListener) == null ? void 0 : _n.call(_m, "transitionend", this.handleUnzoomEnd);
    window.removeEventListener("wheel", this.handleWheel);
    window.removeEventListener("touchstart", this.handleTouchStart);
    window.removeEventListener("touchmove", this.handleTouchMove);
    window.removeEventListener("touchend", this.handleTouchEnd);
